...
> ![version](https://img.shields.io/badge/version-0.13.0-c2410c) ![license](https://img.shields.io/badge/license-MIT-green) ![monorepo](https://img.shields.io/badge/monorepo-Queen·Wing·Antenna·Leg-166534)
>
...
- 🧲 **MCP Server（Spiracle 气门）**：10 个工具覆盖用户操作面（身份/订单查改/反馈/AI/知识库检索与吞入/企微客户档案）——**Claude / Cursor 直连你的后端替你干活**，零额外依赖
