...
export default function AiAssistant() {
  ...
  return (
    <>
      ...
      {open && (
        <div className="fixed bottom-22 right-6 flex h-96 w-80 flex-col overflow-hidden rounded-xl border bg-background shadow-xl">
          <div className="border-b px-4 py-2.5 text-sm font-medium">🧠 AI 助手 · Nerve</div>
