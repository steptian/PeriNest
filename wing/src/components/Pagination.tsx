...
export default function Pagination({
  ...
  if (total <= pageSize) return <p className="px-1 text-xs text-muted-foreground">{t("dialog.total", { total })}</p>;
  const nums: number[] = [];
